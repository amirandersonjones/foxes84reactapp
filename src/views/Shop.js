...
const Shop = props => {
    ...
    const changeStudentOrder = () => {
        ...
        //4.Last -> mutate the state through the propper setter (causing a rerender)
    ...
    return(
        <div>
            ...
            {props.students.map((student, index) => {/* index and key=index are just used to avoid uqiue key warning.helps computer differentiate between H3s*/
