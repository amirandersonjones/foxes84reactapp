...
const Home = () => {
    //component states and the concept of component lifecycle.
    //components state is essentially a collection of data/objects/functions associated with a specific lifecycle of that componenet
    //any time you're working with React and you see a function that is named use___()->that is a hook
    //a hook provides speciall behavior that influences the lifecycle of a component
    ...
    const changeAnimal = () => {
        ...
        //whenenever you mutate state you must make a copy of the current state (if applicable),modify the copy (if neccessary)
    ...
    // useEffect hook - required parameter: a callback function to run when the parent component (Home here)is rendered(intially loaded)or re-rendered(updated)
